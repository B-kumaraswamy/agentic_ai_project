...
from src.langgraphagenticai.ui.streamlit.display_results import DisplayResultsStreamlit
...
def load_langgraph_agentic_app():
    ...
    if user_message :
        try: 
            ...
            # Process the input message and display the output 
            state = State(messages=[{"role": "user", "content": user_message}])
